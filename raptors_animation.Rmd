...
if (nchar(winner) < nchar(loser)){
  ...
  centred_title <- paste0("<b style='color:#000000'>", white_space_needed, "</b>", "<b style='color:", winner_colour, "'>", winner, "</b> {closest_state} <b style='color:", loser_colour, "'>", loser, "</b>")
  
} else {
  white_space_needed <- c(rep("a", times = nchar(winner) - nchar(loser))) %>%
    str_flatten()
  
  centred_title <- paste0("<b style='color:", winner_colour, "'>", winner, "</b> {closest_state} <b style='color:", loser_colour, "'>", loser, "</b>", "<b style='color:#000000'>", white_space_needed, "</b>")
}
```
