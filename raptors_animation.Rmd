...
```{r scrape_data}
page_url <- "https://www.basketball-reference.com/boxscores/pbp/201912220TOR.html"
...
x_axis <- animation_df %>% 
  ...
  labs(title = paste0("<b style='color:#BA0C2F'>Toronto Raptors</b> {closest_state} <b style='color:#002B5C'>", opponent, "</b>"),
       x = "",
       y = "Baskets") +
...
```{r}
anim_save(str_glue("animations/raptors_{opponent}-{str_extract(page_url, '[0-9]+')}.gif"), 
          anim, 
