...
```{r scrape_data}
page_url <- "https://www.basketball-reference.com/boxscores/pbp/201912200TOR.html"
...
base_plot <- animation_df %>%
  ...
  labs(title = "<b style='color:#BA0C2F'>Toronto Raptors</b> {closest_state} <b style='color:#002B5C'>Washington Wizards</b>",
       x = "",
       y = "Baskets") +
