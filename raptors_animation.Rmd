...
team_url <- paste0("https://teamcolorcodes.com/",  tolower(str_replace_all(opponent, " ", "-")), "-color-codes/")
...
base_plot <- animation_df %>%
  ...
  labs(title = paste0("<b style='color:#BA0C2F'>Toronto Raptors</b> {closest_state} <b style='color:", opponent_colour, "'>", opponent, "</b>"),
       caption = paste("Data from:", page_url)) +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        plot.title = element_markdown(size = 45, face = "bold", colour = "#000000",
                                      lineheight = 1, vjust = -1, hjust = 0.56),
        plot.caption = element_text(size = 10, colour = "grey50", hjust = 1, vjust = 10))
